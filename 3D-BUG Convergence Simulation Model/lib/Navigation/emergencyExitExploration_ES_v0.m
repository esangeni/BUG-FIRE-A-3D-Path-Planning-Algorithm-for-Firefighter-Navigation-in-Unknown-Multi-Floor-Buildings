...
%             bug.checkVisibleSigns(robot, [x; y]);
%         end
...
%% Subroutines Functions
        ...
        function rotateTowardsDirection(bug, robot, heading)
            ...
            bug.updateSpottedPointsOfInterest(robot);
        end
...
%                     % Check for visible points of interest
%                     [newGoal, newGoalType] = bug.checkVisiblePointsOfInterest(robot);
%                     if ~isempty(newGoal)
%                         % If a point of interest is found, update the goal
%                         bug.updateGoalBasedOnPointsOfInterest(robot, bug.originalGoal);
...
%                     end
            ...
            if bug.step == 2
                ...
                if bug.k <= numcols(bug.edge)
                    ...
                    % Check for visible points of interest while wall-following
