function [maps, figHandle] = generateEGMap3DBUG_wo_EmergencySigns()
    ...
    for floorNumber = 2:4
        ...
        if exist('x', 'var') && exist('y', 'var')
            stairs = [stairs, [x; y]];
            scatter3(x, y, z, 'filled', 'MarkerFaceColor', 'red', 'MarkerEdgeColor', 'red', 'SizeData',50);
            clear x y
        end
        if exist('x1', 'var') && exist('y1', 'var')
            stairs = [stairs, [x1; y1]];
            scatter3(x1, y1, z, 'filled', 'MarkerFaceColor', 'red', 'MarkerEdgeColor', 'red', 'SizeData',50);
            clear x1 y1
        end
        if exist('x2', 'var') && exist('y2', 'var')
            stairs = [stairs, [x2; y2]];
            scatter3(x2, y2, z, 'filled', 'MarkerFaceColor', 'red', 'MarkerEdgeColor', 'red', 'SizeData',50);
            clear x2 y2
        end
